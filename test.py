...
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QSpacerItem, QScrollArea, QPushButton, QDialog, QGridLayout
from PyQt6.QtGui import QPixmap, QIcon
from PyQt6.QtCore import Qt, QSize, QThreadPool, QRunnable, pyqtSlot, Q_ARG
import sys
from os import getcwd
import requests
from PIL import Image, ImageSequence
from io import BytesIO
from Scripts.seventv import *
...
class EmotesDisplay:
    def __init__(self, mainWindow, widget: QWidget):
        ...
        self.widget = widget
        self.displayWidth = self.widget.size().width() - 35
    ...
    def addEmoteToDisplay(self, emoteToAdd: Emote):
        ...
        last_layout = kids(self.emotes_rows)[-1]
        emotes: list[Emote] = kids(last_layout)
        ...
        kids(self.emotes_rows)[-1].addWidget(emoteToAdd)
